...
<details><summary>Click Here to see the answer</summary><p>
You can see that the gene is expressed (there are reads aligning) in the Mutant, but not in Wild Type control samples.</p>

<img srcset=./images/L06/rpnr12r.jpg alt="Rpnr12r">
