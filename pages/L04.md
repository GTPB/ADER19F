...
<p>You can perform the following operations with Trimmomatic (either isolated, or in combination):</p><ul>
<div style="overflow-x: scroll">
  ...
  <li> AVGQUAL: Drop the read if the average quality is below a specified value

  <li> MAXINFO: Trim reads adaptively, balancing read length and error rate to maximise the value of each read
</ul></div></details>
<br/>
