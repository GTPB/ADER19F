---
layout: page
title: Do simple processing operations in the raw data to improve its quality
---

# <a id="LO4">4: Do simple processing operations in the raw data to improve its quality</a>
