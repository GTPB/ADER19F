---
layout: page
title: Generate tables of counts using the alignment and a reference gene annotation
---

# <a id="LO7">7: Generate tables of counts using the alignment and a reference gene annotation</a>
