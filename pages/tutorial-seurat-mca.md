...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-3-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-4-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-7-1.png)<!-- -->

```r
plot(sobj@meta.data$nUMI, sobj@meta.data$nGene, pch=20, cex=0.5)
```

![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-7-2.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-8-1.png)<!-- -->

```r
plot(sobj@meta.data$nUMI, sobj@meta.data$percent.mito, pch=20, cex=0.5)
```

![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-8-2.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/vargenes-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-10-1.png)<!-- -->

```r
VlnPlot(sobj, features.plot = highest.mean, point.size.use=0.2)
```

![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-10-2.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-11-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-12-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-13-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-14-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/figure-html/tsne-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-15-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-15-2.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-15-3.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-15-4.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-19-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-20-1.png)<!-- -->

```r
FeaturePlot(sobj, features.plot = head(markers.0$gene), cols.use = c("grey", "blue"), reduction.use = "tsne")
```

![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-20-2.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-21-1.png)<!-- -->

```r
VlnPlot(sobj, features.plot = head(markers.7$gene), point.size.use=0.5)
```

![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-21-2.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-24-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-26-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-29-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-30-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-31-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-32-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-33-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-34-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-35-1.png)<!-- -->
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/tutorial-seurat-mca_files/unnamed-chunk-36-1.png)<!-- -->
