...
We are now ready to map the reads to a reference genome or transcriptome. As before in this course, we will use the hisat2 aligner for this task. A pre-indexed *Mus musculus* (mm10) genome is provided in the <code style="background-color:#eaeaea; padding:2px 3px 3px;white-space:pre-wrap">reference</code> folder. 
...
<pre><code style="background-color:#eaeaea; padding:2px 3px 3px;white-space:pre-wrap">
