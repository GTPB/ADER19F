...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/singlecell_collection.png)
...
![Overview of single-cell workflow](https://github.com/maccardoso/ADER18S/blob/master/assets/Chromium10x.png)
...
![Single Cell Transcriptomics Analysis Workflow](https://github.com/maccardoso/ADER18S/blob/master/assets/single-cell-analysis-workflow.jpg)
...
![Barcode Rank Plot](https://github.com/maccardoso/ADER18S/blob/master/assets/barcode-rank-plot.png)
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/sequencing_saturation.png)
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/cellranger_tsne.png)
...
![](https://github.com/maccardoso/ADER18S/blob/master/assets/de_evaluation.png)
...
**TASK**: Using what you learned, perform on your own a downstream analysis of the PBMC4k 10x dataset. Use the following document as a guide, but try to perform the analysis steps on your own, by modifying the commands used in the previous tutorial: [Analysis of PBMC4k using Seurat](exercise-seurat-pbmc4k.md).
